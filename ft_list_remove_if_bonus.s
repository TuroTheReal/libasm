...
; ft_list_remove_if - Supprime les éléments qui satisfont une condition
...
.remove_head_loop:
    ...
    ; Préparer les arguments pour cmp(current->data, data_ref)
    mov rdi, [rbx]          ; rdi = current->data (premier argument)
    mov rsi, r13            ; rsi = data_ref (deuxième argument)
...
.check_result_head:
    test eax, eax
    jnz .process_body       ; si != 0, passer au corps de la liste
